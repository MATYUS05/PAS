    ...
    useEffect(() => {
        ...
        if (kataText && hintText) {
            const initTimer = maxTime => {
                ...
                timerRef.current = setInterval(() => {
                    if (maxTime > 0) {
                        ...
                        clearInterval(timerRef.current);
                        alert(`Time off! ${correctWordRef.current.toUpperCase()} was the correct word`);
                        initGame();
                    }
                }, 1000);
            }
            ...
            const checkWord = () => {
                ...
                if (userWord !== correctWordRef.current) return alert(`Oops! ${userWord} is not correct`);
        ...
        <div className="containers">
            ...
            <div className="content">
                ...
                <div className="detail">
                    <p className="hint">Hint : <span></span></p>
                    <p className="time">Sisa Waktu : <span><b>30</b>s</span></p>
                </div>
                <input type="text" placeholder="Masukkan kata yang tepat" ref={inputRef} />
